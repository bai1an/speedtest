...
<head>
    ...
    <script src="/cdn-cgi/apps/head/N_zUuban6PxjcDUaatc2swmBxLo.js"></script><link rel="shortcut icon" href="favicon.ico">
    ...
    <link href="https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-y/material-components-web/3.0.0/material-components-web.min.css" type="text/css" rel="stylesheet" />
    <style>
        body {
    ...
    <link rel="stylesheet" href="https://fonts.loli.net/css?family=Roboto:300,400,500">
...
<body>
    ...
    <main class="main-content mdc-typography mdc-elevation--z8">
        ...
        <button class="theme-toggle mdc-fab mdc-fab--mini" aria-label="Toggle Theme Settings" data-mdc-auto-init="MDCRipple">
		 ...
		 <p class="mdc-typography--body1">当前测速源：Qcloud ，切换回默认节点，请点击<a href="index.html">返回主页</a></p>
        <br>
      ...
      <span class="mdc-list-item__primary-text">运行时长</span>
            ...
            <li class="mdc-list-item" data-mdc-auto-init="MDCRipple">
                 <svg class="mdc-list-item__graphic" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" width="24px" fill="#000000">
                    <path d="M0 0h24v24H0z" fill="none"/>
                    <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
                <span class="mdc-list-item__text">
      <span class="mdc-list-item__primary-text">ip地址</span>
                   <iframe src="https://ip.vv1234.cn/" width="100%" height="30" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"> 
</iframe> 
   ...
   <!-- [if lt IE 9]> <script async src="https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-y/html5shiv/3.7.3/html5shiv-printshiv.min.js" type="application/javascript" crossorigin="anonymous"></script> <![endif]-->
    ...
    <script src="https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-y/material-components-web/3.0.0/material-components-web.min.js" type="application/javascript"></script>
    
    <!--<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>-->
     <!--<<script src="https://cdn.jsdelivr.net/npm/jquery@3.4.1/dist/jquery.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>-->
    <script src="https://lf6-cdn-tos.bytecdntp.com/cdn/expire-1-y/jquery/3.4.1/jquery.min.js" type="application/javascript"></script>
   ...
   <!-- <script src="https://unpkg.com/stopwatchjs@0.1.1/stopwatch.min.js" integrity="sha384-YVHQrJc4DzNQAtLqXkQ+16NBc9BuQSEWt5At/0hgASbDJ+659CMhYJeuh2EHtqJ8" crossorigin="anonymous"></script> -->
    ...
    <script src="https://npm.elemecdn.com/stopwatchjs@0.1.1/stopwatch.min.js" crossorigin="anonymous"></script>
   ...
   <!-- <script async src="https://cdn.jsdelivr.net/gh/EvanHahn/HumanizeDuration.js@3.20.0/humanize-duration.min.js" integrity="sha256-/Z/Xzo8lduQxHd+muddFmswME6zBTWH+UGYdNEE0upo=" crossorigin="anonymous"></script>-->
    <script async src="https://lf6-cdn-tos.bytecdntp.com/cdn/expire-1-y/humanize-duration/3.20.0/humanize-duration.min.js" type="application/javascript"></script>
    ...
    <script async src="https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-y/filesize/4.1.2/filesize.min.js" type="application/javascript"></script>
    <script>
        mdc.autoInit();
        ...
        var download = function(id) {
            ...
            if (running == true)
                xhr[id] = $.get("https://game.gtimg.cn/images/nz/web202106/index/bc_part1.gif?" + Math.random(), function() {
                    return download(id);
                });
        };
